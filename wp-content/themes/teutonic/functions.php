...
function event_post_type() {
    ...
    $labels = array(
        'name'                => __( 'Events', 'Post Type General Name', 'text_domain' ),
        'singular_name'       => __( 'Event', 'Post Type Singular Name', 'text_domain' ),
...
function buzz_post_type() {

    $labels = array(
        'name'                => __( 'Buzz', 'Post Type General Name', 'text_domain' ),
        'singular_name'       => __( 'Buzz', 'Post Type Singular Name', 'text_domain' ),
        'menu_name'           => __( 'Buzz', 'text_domain' ),
        'name_admin_bar'      => __( 'Buzz', 'text_domain' ),
        'parent_item_colon'   => __( 'Buzz', 'text_domain' ),
        'all_items'           => __( 'All Buzz', 'text_domain' ),
        'add_new_item'        => __( 'Add New Buzz', 'text_domain' ),
        'add_new'             => __( 'New Buzz', 'text_domain' ),
        'new_item'            => __( 'New Buzz', 'text_domain' ),
        'edit_item'           => __( 'Edit Buzz', 'text_domain' ),
        'update_item'         => __( 'Update Buzz', 'text_domain' ),
        'view_item'           => __( 'View Buzz', 'text_domain' ),
        'search_items'        => __( 'Search Buzz', 'text_domain' ),
        'not_found'           => __( 'No Buzz found', 'text_domain' ),
        'not_found_in_trash'  => __( 'No Buzz found in Trash', 'text_domain' ),
    );
    $args = array(
        'label'               => __( 'Buzz', 'text_domain' ),
        'description'         => __( 'Buzz', 'text_domain' ),
        'labels'              => $labels,
...
// Hook into the 'init' action
add_action( 'init', 'cellar_wine_post_type', 0 );
/*------------------------------------*\
...
function get_permalink_by_name($page_name)
{
     global $post;
     global $wpdb;
     $id = $wpdb->get_var("SELECT ID FROM $wpdb->posts WHERE page_name = '".$page_name."'");
